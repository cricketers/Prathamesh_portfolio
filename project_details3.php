...
<div class="container mt-5">
        ...
        <div class="row">
            <div class="col-12">
                <img src="assets/images/project_details3.jpg" alt="Project Main Image" class="img-fluid main-image">
            </div>
        </div>
        <div class="row mt-4">
            <div class="col-12">
                <h1 class="project-title">Dr. Chandru's Prakritik Chikitsa</h1>
            </div>
        </div>
        ...
        <div class="row mt-4">
            <div class="col-lg-12 col-md-12">
                ...
                I am developing a project titled "Dr. Chandru's Prakritik Chikitsa - Naturopathy", focusing on creating a responsive and visually appealing frontend. The design utilizes HTML, CSS, and the Bootstrap framework, ensuring compatibility across various devices. Additionally, the project integrates a third-party application to enhance functionality, offering a seamless user experience. The aim is to reflect the essence of naturopathy through an elegant and user-friendly interface. Every design element is carefully crafted to maintain consistency, clarity, and responsiveness, aligning with modern web development standards and user expectations.           
               </p>             
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
            <div class="card h-100 shadow">
                <img src="assets/images/blog_project.jpg" class="card-img-top" alt="Blog Mangement System" style="height: 200px; object-fit: cover;">
                <div class="card-body d-flex flex-column">
                    <h5 class="text-capitalize fs-5">Blog Mangement System</h5>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
            <div class="card h-100 shadow">
                <img src="assets/images/project_details2.jpg" class="card-img-top" alt="Naturopathy Project" style="height: 200px; object-fit: cover;">
                <div class="card-body d-flex flex-column">
