...
<div class="container mt-5">
        ...
        <div class="row">
            <div class="col-12">
                <img src="assets/images/project_details2.jpg" alt="Project Main Image" class="img-fluid main-image">
            </div>
        </div>
        <div class="row mt-4">
            <div class="col-12">
                <h1 class="project-title">Ev charging system</h1>
            </div>
        </div>
        ...
        <div class="row mt-4">
            <div class="col-lg-12 col-md-12">
                ...
                I am developing an EV charging system using PHP, with a primary focus on backend development. My responsibilities include creating a master page to ensure a consistent layout across the platform, designing and managing a robust database to handle user and transaction data efficiently, and integrating secure payment gateways for seamless transactions. The project aims to provide a user-friendly and reliable system for managing EV charging services, enhancing accessibility and convenience for users while ensuring smooth operational workflows and secure financial processes.
              </p>             
